...
public class Tutorialcontroller extends Main{
	@FXML
	Rectangle arena;
	@FXML
	Pane arenaPane;
		...
		public void initialize() {
		 ...
		 public void initPlayer() {
		    ...
		    private void tutorial1() {
		    	txtCompleted.setText("Move around using WASD. That box on the middle bottom is your text input. Press CONTROL to open it.");
		    }
		    
		    private void tutorial2() {
		    	txtCompleted.setText("Great! Pressing CONTROL opens the box, which stops you from moving.\n Now try typing \"cd\" and press ENTER.");
		    }
		    
		    private void tutorial3() {
		    	txtCompleted.setText("Cool! Nothing happened. That command selects the nearest enemy. Speaking of, try entering \"cd\" and then entering \"rm\" against this enemy!");
		    	enemiesleft=1;
		    	generateEnemies();
		    }
		    private void tutorial4() {
		    	txtCompleted.setText("Wow, look at that enemy disappear."
		    			+ "\nFor killing all the enemies, you unlocked a new command: \"magick\". Kill these next enemies by using \"cd\" and \"magick\". ");
		    	enemiesleft=3;
		    	generateEnemies();
				  
		    }
		    private void tutorial5() {
		    	txtCompleted.setText("Excellent commanding! You're now ready for the real game. Oh, and dont let the enemies run into you. You'll die. See ya!");
				
			}
		    
		    private void tutorial42() {
		    	txtCompleted.setText("Notice that using \"magick\" costs mana, that blue bar. Be mindful of your mana when casting commands.");
		    ...
		    if (tutorialcounter<1) {
		    	tutorial1();
		    	if (keyInput.contains("CONTROL")) {
		    		tutorial2(); tutorialcounter++;
		    	}
		    }else
		    if (tutorialcounter<2) {
		    	if (cdflag==true) {
		    	tutorial3(); tutorialcounter++;
		    	}
		    }else 
		    	if (tutorialcounter<3) {
			    	if (prevcmd.equals("cd")&&currcmd.equals("rm")) {
			    		tutorial4(); tutorialcounter++;
			    	}
